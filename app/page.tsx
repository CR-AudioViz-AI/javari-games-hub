  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', color: '#e2e8f0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui' }}>
      <div style={{ textAlign: 'center', maxWidth: 560, padding: '40px 24px' }}>
        ...
        <h1 style={{ fontSize: 32, fontWeight: 800, margin: '0 0 16px', color: '#fff' }}>Javari Games Hub</h1>
        <p style={{ fontSize: 16, color: '#9ca3af', lineHeight: 1.65, margin: '0 0 32px' }}>Discover and track games across all platforms. AI-powered recommendations.</p>
        <a href="https://craudiovizai.com/auth/signup"
          style={{ background: '#10b981', color: '#000', borderRadius: 10, padding: '14px 32px', fontSize: 15, fontWeight: 700, textDecoration: 'none', display: 'inline-block' }}>
          Get Started Free →
        </a>
